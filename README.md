...
1. Download [VBoxGuestAdditions_7.2.6.iso](https://download.virtualbox.org/virtualbox/7.2.6/VBoxGuestAdditions_7.2.6.iso) and put it into the root directory of repository.
1. Run
    ```bash
